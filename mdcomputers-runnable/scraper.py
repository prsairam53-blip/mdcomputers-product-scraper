...
def parse_product(card):
    ...
    product_url = urljoin(BASE_URL, name_tag.get("href", "")) if name_tag else ""
    image_url = urljoin(BASE_URL, image_tag.get("src", "")) if image_tag else ""
    ...
    return {
        ...
        "old_price": old_price,
        "shipping_or_stock": badges[0] if badges else "",
